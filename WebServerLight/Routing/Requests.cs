...
static class Requests
{
    ...
    public static async ValueTask<bool> ServeGet(Server server, Message msg)
    {
    ...
    async static Task<bool> ServePostJsonRequest(Server server, Message msg)
    {
        var url = msg.Url.SubstringUntil('?');
    ...
    async static Task<bool> ServeOptions(Server server, Message msg)
    {
